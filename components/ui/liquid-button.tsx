...
function LiquidButton({
  ...
  return (
    <button
      className={`group/liquid relative isolate inline-flex h-12 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-blue-300/30 bg-navy-950 px-6 text-sm font-semibold whitespace-nowrap text-white shadow-[0_12px_32px_-14px_rgba(47,111,239,0.8)] transition-[transform,box-shadow,border-color] duration-300 outline-none select-none hover:border-blue-300/70 hover:shadow-[0_16px_40px_-12px_rgba(47,111,239,0.95)] focus-visible:border-blue-300 focus-visible:ring-3 focus-visible:ring-blue-300/35 active:translate-y-px active:scale-[0.98] disabled:pointer-events-none disabled:opacity-45 disabled:shadow-none ${className}`}
      type={type}
      {...props}
    >
      <span
        aria-hidden="true"
        className="absolute -inset-x-1/4 top-[96%] z-0 h-[190%] bg-gradient-to-b from-blue-400 via-blue-500 to-indigo-700 transition-transform duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover/liquid:-translate-y-[58%] group-focus-visible/liquid:-translate-y-[58%] group-disabled/liquid:translate-y-0 motion-reduce:transition-none"
      >
